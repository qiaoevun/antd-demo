...
import { logoutUser,getTitle } from './../actions/auth';
...
class App extends Component{
  ...
  componentDidMount(){
    const { isAuthenticated } = this.props.auth;
    const { dispatch } = this.props;
    //if(isAuthenticated) dispatch(getTitle(this.onError));
  }
  onError(e){
    message.error(e);
  }
        ...
        <div className={styles.head} id="react-top">
          ...
          <div className={styles.rightnav}>
              <Menu  
                ...
                <SubMenu title={<span><img height="24" src={defaultUser} style={{marginRight:8,borderRadius:'50%',verticalAlign: 'middle'}} />{name}</span>}>
